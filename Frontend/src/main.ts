...
const routes: Routes = [
  ...
  { path: 'channel/:id/branding', loadComponent: () => import('./app/components/channel-branding/channel-branding.component').then(m => m.ChannelBrandingComponent), canActivate: [authGuard] },
  { path: 'subscription-plans', loadComponent: () => import('./app/components/subscription-plans/subscription-plans.component').then(m => m.SubscriptionPlansComponent), canActivate: [authGuard] },
  { path: 'subscription-management', loadComponent: () => import('./app/components/subscription-management/subscription-management.component').then(m => m.SubscriptionManagementComponent), canActivate: [authGuard] },
  ...
  { path: 'quota', loadComponent: () => import('./app/components/quota-dashboard/quota-dashboard.component').then(m => m.QuotaDashboardComponent), canActivate: [authGuard] },
