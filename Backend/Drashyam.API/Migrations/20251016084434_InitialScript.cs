        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxVideosPerChannel = table.Column<int>(type: "integer", nullable: false),
                    ...
                    HasMonetization = table.Column<bool>(type: "boolean", nullable: false),
                    HasLiveStreaming = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdContent = table.Column<string>(type: "text", nullable: true),
                    AdUrl = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdCampaigns_AspNetUsers_AdvertiserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentVideoCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WasClicked = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdImpressions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AdImpressions_Videos_VideoId",
                        column: x => x.VideoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Analytics_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Analytics_Videos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "Videos",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoId = table.Column<int>(type: "integer", nullable: false),
                    ViewedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    WatchDuration = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "BillingCycle", "CreatedAt", "Description", "HasAds", "HasAnalytics", "HasLiveStreaming", "HasMonetization", "IsActive", "MaxChannels", "MaxStorageGB", "MaxVideosPerChannel", "Name", "Price", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, 0, new DateTime(2025, 10, 16, 8, 44, 33, 650, DateTimeKind.Utc).AddTicks(4085), "Basic features with ads", true, false, false, false, true, 1, 1, 10, "Free", 0m, null },
                    { 2, 0, new DateTime(2025, 10, 16, 8, 44, 33, 650, DateTimeKind.Utc).AddTicks(4469), "Ad-free experience with enhanced features", false, true, true, false, true, 3, 50, 100, "Premium", 9.99m, null },
                    { 3, 0, new DateTime(2025, 10, 16, 8, 44, 33, 650, DateTimeKind.Utc).AddTicks(4474), "Full features with monetization", false, true, true, true, true, 10, 500, 1000, "Pro", 19.99m, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdImpressions_VideoId",
                table: "AdImpressions",
                column: "VideoId");

            migrationBuilder.CreateIndex(
                name: "IX_Analytics_ChannelId",
                table: "Analytics",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_Analytics_Date",
                table: "Analytics",
                column: "Date");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelSubscriptions_UserId_ChannelId",
                table: "ChannelSubscriptions",
